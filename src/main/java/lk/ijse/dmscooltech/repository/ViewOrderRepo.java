...
public class ViewOrderRepo {
    ...
    public static List<ViewOrders> getViewOrdersByOrderId(String orderId) throws SQLException {
        String sql = "SELECT cId,orders.oId,ODate,iCode,qty,unitPrice,oPrice FROM orderdetails JOIN orders ON orderdetails.oid = orders.oid WHERE orders.oid = ?";
